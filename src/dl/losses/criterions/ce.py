...
class CELoss(WeightedBaseLoss):
    def __init__(
        ...
        """
        Wrapper class around CE loss function that applies weights with
        fixed factor. This class adds nuclei border weights to the final
        computed loss
    ...
    def forward(
        ...
        ----------
            yhat (torch.Tensor): 
                The feature map generated from the forward pass
            target (torch.Tensor):
