...
class WSConv2dStaticSamePadding(nn.Conv2d):
    def __init__(self, 
                 ...
                 **kwargs) -> None:
        """
        Tensorflow like convolution with "SAME" padding. padding computed from the input
        image size in the constructor and used in forward
        ...
        Why?:
            Needed to make model builder etc compatible with the efficient-net encoder
            that seems to perform better than other encoders.
