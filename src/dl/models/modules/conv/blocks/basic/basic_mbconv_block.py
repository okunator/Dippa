...
from .basic_mbconv import InvertedBottleneck, InvertedBottleneckPreact


class MobileInvertedBasicBlock(nn.ModuleDict):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
        ...
        **kwargs
        ...
        """
        Stack inverted bottleneck blocks in a ModuleDict. These can be 
