...
from .residual_dws import DepthWiseSeparableResidual, DepthWiseSeparableResidualPreact


class DepthWiseSeparableResidualBlock(nn.ModuleDict):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
        ...
        **kwargs
        ...
        """
        Stack dws residual blocks in a ModuleDict. These can be used
        ...
        DWS = DepthWiseSeparableResidual
        if preactivate:
            DWS = DepthWiseSeparableResidualPreact
