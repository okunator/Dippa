    ...
    def __init__(self,
        ...
        if skip_index < len(skip_channel_list):
            ...
            for i in range(skip_index):
                ...
                if reduce_params:
                    # if reduce_params, encoder and sub skips get pooled to num out_channels
            ...
            self.final_merge = SumBlock(
                ...
                current_channels=current_skip_chl if not reduce_params else out_channel_list[skip_index]
            )
