...
class MultiBlockBasic(nn.ModuleDict):
    def __init__(self,
        ...
        self.conv1 = BasicConvBlock(in_channels, out_channels, same_padding, batch_norm, activation, weight_standardize)
        for i in range(1, n_blocks):
            conv_block = BasicConvBlock(out_channels, out_channels, same_padding, batch_norm, activation, weight_standardize)
