...
class TilerStitcherTorch:
    def __init__(
        ...
        """
        Patch extractor and stitcher class. Operates on batched torch 
        tensors. I.e tensors of shape: (B, C, H, W)
    ...
    def extract_patches_from_batched(
            self, 
        ...
        Returns:
        -------------
            torch.Tensor: patched image of shape 
            (B, C, n_patches, patch_height, patch_width)
        """
        if self.padding:
